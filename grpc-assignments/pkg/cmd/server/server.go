...
import (
	...
	"github.com/rahul/grpc-assignments/pkg/protocol/grpc"
	"github.com/rahul/grpc-assignments/pkg/protocol/rest"
)
...
func RunServer() error {
	...
	flag.StringVar(&cfg.DatastoreDBSchema, "db-schema", "grpc_example", "Database schema")
	flag.Parse()
