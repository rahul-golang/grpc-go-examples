...
func request_LibraryService_IssueBook_0(ctx context.Context, marshaler runtime.Marshaler, client LibraryServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq IssueBookReq
	...
	msg, err := client.IssueBook(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
...
func RegisterLibraryServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client LibraryServiceClient) error {
	...
	mux.Handle("POST", pattern_LibraryService_IssueBook_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_LibraryService_IssueBook_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_LibraryService_IssueBook_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_LibraryService_IssueBook_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "libraryservice", "library"}, ""))
)

var (
	forward_LibraryService_IssueBook_0 = runtime.ForwardResponseMessage
)
