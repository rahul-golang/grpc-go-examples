...
import (
	...
	"github.com/rahul/go-grpc-microservice-tutorial/pkg/protocol/grpc"
	v1 "github.com/rahul/go-grpc-microservice-tutorial/pkg/service/v1"
)
...
func RunServer() error {
	...
	v1API1 := v1.NewBookServiceServer(db)

	//v1API1:=v1.NewBookServiceServer(db)

	return grpc.RunServer(ctx, v1API, v1API1, cfg.GRPCPort)
}
